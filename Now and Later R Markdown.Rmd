---
title: "Now and Later R Analyses"
knit: (function(input_file, encoding) {
    out_dir <- 'docs';
    rmarkdown::render(input_file,
      encoding=encoding,
      output_file=file.path(dirname(input_file), out_dir, 'Now_Later.html'))})
author: "RSF"
date: "01/06/2022"
...
#3: Table 2. Group level changes in MVPA and SB over time
```{r}
library(lme4)
library(robustlmm)
library(lsmeans)
...
#3: Figure 3: Individual changes in MVPA and SB Across Time
```{r}
